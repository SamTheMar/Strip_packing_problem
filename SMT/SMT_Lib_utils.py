...
def compute_all_instances_SMT(input_range=range(40), plot=True, save_to_file=True, verbose=True, allow_rotation=False, sorting_by_area=True, break_symmetries=True, solver='z3', logic='LIA', timeout=300, plot_kw={}):
